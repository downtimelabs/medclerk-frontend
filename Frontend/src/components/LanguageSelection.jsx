          ...
          <div className="card">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
              {languages.map((language) => (
                <button
                  key={language.code}
                  className={`flex flex-col items-center p-5 border border-dark-100 rounded-xl bg-white cursor-pointer transition-all duration-300 text-sm font-medium text-dark-700 hover:border-primary-500 hover:-translate-y-0.5 hover:shadow-lg hover:bg-dark-50 ${
                    selectedLang === language.code 
                      ? 'border-primary-500 bg-primary-50 text-primary-700 -translate-y-0.5 shadow-lg' 
                      : ''
                  }`}
