  ...
  return (
    <div className="min-h-screen flex flex-col relative text-dark-700 dark:text-dark-100">
      ...
      <div className="fixed inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br from-white/80 via-blue-50/70 to-blue-100/70 dark:from-black/60 dark:via-slate-900/60 dark:to-slate-900/60"></div>
      </div>
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        >
          ...
          >
            <div className="relative h-full flex items-center">
              <button
                className={`relative px-3 py-2 transition-all duration-300 ease-in-out group text-dark-700 dark:text-dark-200 ${isActive('/') ? 'text-primary-600' : 'hover:text-primary-600'
                  }`}
                onClick={() => navigate('/')}
              >
                <span className="relative flex flex-col items-center">
                  <span>{t('home')}</span>
                  <span
                    className={`mt-1 h-0.5 bg-primary-500 rounded-full transition-all duration-300 ease-in-out ${isActive('/')
                      ? 'w-full opacity-100'
            ...
            <div className="relative h-full flex items-center">
              <button
                className={`relative px-3 py-2 transition-all duration-300 ease-in-out group text-dark-700 dark:text-dark-200 ${isActive('/services') ? 'text-primary-600' : 'hover:text-primary-600'
                  }`}
              ...
              >
                <span className="relative flex flex-col items-center">
                  ...
                  <span
                    className={`mt-1 h-0.5 bg-primary-500 rounded-full transition-all duration-300 ease-in-out ${isActive('/services')
                      ? 'w-full opacity-100'
                      : 'w-0 opacity-0 group-hover:w-full group-hover:opacity-70'
                      }`}
                  ></span>
            ...
            <div className="relative h-full flex items-center">
              <button
                className={`relative px-3 py-2 transition-all duration-300 ease-in-out group text-dark-700 dark:text-dark-200 ${isActive('/about') ? 'text-primary-600' : 'hover:text-primary-600'
                  }`}
              ...
              >
                <span className="relative flex flex-col items-center">
                  ...
                  <span
                    className={`mt-1 h-0.5 bg-primary-500 rounded-full transition-all duration-300 ease-in-out ${isActive('/about')
                      ? 'w-full opacity-100'
                      : 'w-0 opacity-0 group-hover:w-full group-hover:opacity-70'
                      }`}
                  ></span>
            ...
            {isAuthenticated ? (
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-300 ${isScrolled
                      ...
                      : isPro
                        ...
                        : 'bg-gradient-to-r from-indigo-600/90 to-indigo-700/90 text-white hover:opacity-90'
                      }`}
                  >
                    {isPro ? (
                      <>
              ...
              <div className="flex items-center gap-2">
                ...
                <motion.button
                  className="bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:from-blue-600 hover:to-blue-700 transition-all px-4 py-1.5 rounded-lg text-sm shadow-md"
        ...
        >
          ...
          >
            <div className="relative z-10">
              <div className="w-14 h-14 rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 text-white flex items-center justify-center mb-5 shadow-lg">
        ...
        <motion.section
          className="py-20 px-6 bg-gradient-to-br from-blue-50 via-blue-100 to-indigo-50"
          initial={{ opacity: 0 }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
              {[1, 2, 3, 4, 5, 6].map((num, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center mb-6 shadow-lg">
              ...
              {[1, 2, 3].map((step, index) => (
                ...
                >
                  <div className="relative inline-block mb-6">
                    ...
                    {index < 2 && (
                      <div className="hidden md:block absolute top-1/2 left-full w-32 h-1 bg-gradient-to-r from-blue-500 to-blue-600 opacity-30 transform -translate-y-1/2"></div>
                    )}
                  </div>
        ...
        {/* CTA Section */}
        <motion.section
          className="py-20 px-6 bg-gradient-to-r from-blue-500 to-blue-600 text-white dark:from-dark-700 dark:to-dark-800"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <motion.button
                className="bg-white text-blue-600 hover:bg-blue-50 transition-all px-10 py-4 rounded-lg text-lg font-bold shadow-2xl"
                onClick={() => navigate('/signup')}
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <ul className="space-y-3">
                  <li>
                    <motion.button
                      className="text-dark-600 hover:text-blue-600 transition-colors text-sm block w-full text-left"
                      onClick={() => navigate('/signup')}
                      whileHover={{ x: 5 }}
                    >
                      How it Works
